$(document).ready(function() {
	...
	$('#z').css({'color': '#76FF03', 'filter': 'blur(0px)', '-webkit-filter': 'blur(0px)'});
	$('#scramble').TickerScrambler({
		charset: ' ',
		index: 1,
		list: ['Survival', 'Emergency Preparedness', 'Epidemic Preparedness', 'Apocalypse Preparedness', 'Zombie Preparedness', 'Disaster Preparedness'],
		pause: 4000,
		speed: 20,
	});
});
